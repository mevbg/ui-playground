export default {
  // Errors
  LOCL_THE_PAGE_DOES_NOT_EXIST: 'Страницата не съществува',
  LOCL_A_SYSTEM_ERROR_OCCURRED: 'Възникна системна грешка',

  // Core
  LOCL_SITE_TITLE: 'Mev’s UI Playground',
  LOCL_SITE_DESCRIPTION: 'Mev’s personal UI playground',
